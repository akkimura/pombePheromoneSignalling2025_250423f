...
% add s(27) as ppSpk1 -| (Ras1->Cdc42) (s(9)) in a Ras.Val specific manner
% add s(28) as ppSpk1 -| (Ras1->Byr1) (s(14)) in a Ras.Val specific manner
% see 220122RunFitting.xlsx
% 29 parameters

function dydt = diffunModel_CE29(~,y,r)
dydt = zeros(32,1);
...
dydt(11) = s(13)*y(9)*(1+s(14)*s(22)/(1+s(29)*y(13))+s(15)*y(10)/s(19))*(1-y(11))-s(16)*(1+s(26)*(1-y(31)))*y(11); %phospho-Byr1 in ras1.G17V 
