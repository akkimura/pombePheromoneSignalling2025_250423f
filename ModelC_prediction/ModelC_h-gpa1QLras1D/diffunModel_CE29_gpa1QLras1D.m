% diffunModel_CE29_gpa1QLras1D.m
% made on Apr 22, 2022, based on diffunModel_CE29.m
% y(2)=y(9)=y(15)=y(21)=y(26)=gpa1QL(=0.2)
% y(3)=s(22)=y(16)=y(27)=0
% 29 parameters

function dydt = diffunModel_CE29_gpa1QLras1D(~,y,r)
dydt = zeros(32,1);
gpa1QL = 0.2;
dydt(2)=gpa1QL;
dydt(9)=gpa1QL;
...
dydt(3) = s(7)*gpa1QL*(1-0) - s(8)*0; %active Ras in WT
dydt(4) = s(19)*(s(9)*0*(1-y(4)/s(19)) - s(10)*(1+s(11)*(1-y(31)))*y(4)/s(19)); %active Cdc42 in WT. +Cdc42GAP (210610)
dydt(5) = s(13)*gpa1QL*(1+s(14)*0+s(15)*y(4)/s(19))*(1-y(5))-s(16)*(1+s(26)*(1-y(31)))*y(5); %phospho-Byr1 in WT
...
dydt(11) = s(13)*gpa1QL*(1+s(14)*0/(1+s(29)*y(13))+s(15)*y(10)/s(19))*(1-y(11))-s(16)*(1+s(26)*(1-y(31)))*y(11); %phospho-Byr1 in ras1.G17V 
...
dydt(16) = s(7)*gpa1QL*(1-0) - s(8)*0; %active Ras in byr1.DD
...
dydt(27) = s(7)*gpa1QL*(1-0) - s(8)*0; %active Ras in scd1-Delta
% 0; % Cdc42 in scd1-Delta
dydt(28) = s(13)*gpa1QL*(1+s(14)*0)*(1-y(28))-s(16)*(1+s(26)*(1-y(31)))*y(28); %phospho-Byr1 in scd1-Delta
