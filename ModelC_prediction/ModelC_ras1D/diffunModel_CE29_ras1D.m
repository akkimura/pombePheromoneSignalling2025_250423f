% diffunModel_CE29_ras1D.m
% made on Apr22, 2022, based on diffunModel_CE29.m
% y(3)=y(16)=y(27)=0, s(22)=0
% 29 parameters

function dydt = diffunModel_CE29_ras1D(~,y,r)
dydt = zeros(32,1);
...
dydt(3) = s(7)*y(2)*(1-0) - s(8)*0; %active Ras in WT
dydt(4) = s(19)*(s(9)*0*(1-y(4)/s(19)) - s(10)*(1+s(11)*(1-y(31)))*y(4)/s(19)); %active Cdc42 in WT. +Cdc42GAP (210610)
dydt(5) = s(13)*y(2)*(1+s(14)*0+s(15)*y(4)/s(19))*(1-y(5))-s(16)*(1+s(26)*(1-y(31)))*y(5); %phospho-Byr1 in WT
...
dydt(10) = s(19)*(s(9)*0*(1-y(10)/s(19))/(1+s(28)*y(13)) - s(10)*(1+s(11)*(1-y(31)))*y(10)/s(19)); %active Cdc42 in ras1.G17V. +Cdc42GAP
dydt(11) = s(13)*y(9)*(1+s(14)*0/(1+s(29)*y(13))+s(15)*y(10)/s(19))*(1-y(11))-s(16)*(1+s(26)*(1-y(31)))*y(11); %phospho-Byr1 in ras1.G17V 
...
dydt(16) = s(7)*y(15)*(1-0) - s(8)*0; %active Ras in byr1.DD
...
dydt(22) = s(19)*(s(9)*0*(1-y(22)/s(19))/(1+s(28)*y(24)) - s(10)*(1+s(11)*(1-y(31)))*y(22)/s(19)); %active Cdc42 in ras1.G17V+byr1.DD. +Cd
%s(23); %phospho-Byr1 in byr1.DD
...
dydt(27) = s(7)*y(26)*(1-0) - s(8)*0; %active Ras in scd1-Delta
% 0; % Cdc42 in scd1-Delta
dydt(28) = s(13)*y(26)*(1+s(14)*0)*(1-y(28))-s(16)*(1+s(26)*(1-y(31)))*y(28); %phospho-Byr1 in scd1-Delta
