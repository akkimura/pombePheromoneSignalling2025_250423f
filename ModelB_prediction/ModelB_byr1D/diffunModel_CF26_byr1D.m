...
function dydt = diffunModel_CF26_byr1D(~,y,r)
dydt = zeros(32,1);
...
dydt(5) = s(13)*y(2)*(1+s(14)*y(3)+s(15)*y(4)/s(19))*(1-0)-s(16)*(1+s(26)*(1-y(31)))*0; %phospho-Byr1 in WT
dydt(6) = s(17)*y(1) - s(18)*y(6); % total Spk1 in WT
dydt(7) = s(20)*0*(y(6)-(y(7)/s(12))) - s(21)*(y(7)/s(12)); % phospho-Spk1 in WT 
...
dydt(11) = s(13)*y(9)*(1+s(14)*s(22)+s(15)*y(10)/s(19))*(1-0)-s(16)*(1+s(26)*(1-y(31)))*0; %phospho-Byr1 in ras1.G17V 
dydt(12) = s(17)*y(8) - s(18)*y(12); % total Spk1 in ras1.G17V
dydt(13) = s(20)*0*(y(12)-(y(13)/s(12))) - s(21)*(y(13)/s(12)); % phospho-Spk1 in ras1.G17V 
...
dydt(19) = s(20)*0*(y(18)-(y(19)/s(12))) - s(21)*(y(19)/s(12)); % phospho-Spk1 in byr1.DD 
...
dydt(24) = s(20)*0*(y(23)-(y(24)/s(12))) - s(21)*(y(24)/s(12)); % phospho-Spk1 in ras1.G17V+byr1.DD, new 210402a
...
dydt(28) = s(13)*y(26)*(1+s(14)*y(27))*(1-0)-s(16)*(1+s(26)*(1-y(31)))*0; %phospho-Byr1 in scd1-Delta
dydt(29) = s(17)*y(25) - s(18)*y(29); % total Spk1 in scd1-Delta
dydt(30) = s(20)*0*(y(29)-(y(30)/s(12))) - s(21)*(y(30)/s(12)); % phospho-Spk1 in scd1-Delta 
