...
function dydt = diffunModel_CF26_gpa1QL(~,y,r)
dydt = zeros(32,1);
...
dydt(3) = s(7)*0.01*(1-y(3)) - s(8)*y(3); %active Ras in WT
dydt(4) = s(19)*(s(9)*y(3)*(1-y(4)/s(19)) - s(10)*(1+s(11)*(1-y(31)))*y(4)/s(19)); %active Cdc42 in WT. +Cdc42GAP (210610)
dydt(5) = s(13)*0.01*(1+s(14)*y(3)+s(15)*y(4)/s(19))*(1-y(5))-s(16)*(1+s(26)*(1-y(31)))*y(5); %phospho-Byr1 in WT
...
dydt(11) = s(13)*0.01*(1+s(14)*s(22)+s(15)*y(10)/s(19))*(1-y(11))-s(16)*(1+s(26)*(1-y(31)))*y(11); %phospho-Byr1 in ras1.G17V 
...
dydt(16) = s(7)*0.01*(1-y(16)) - s(8)*y(16); %active Ras in byr1.DD
...
dydt(27) = s(7)*0.01*(1-y(27)) - s(8)*y(27); %active Ras in scd1-Delta
% 0; % Cdc42 in scd1-Delta
dydt(28) = s(13)*0.01*(1+s(14)*y(27))*(1-y(28))-s(16)*(1+s(26)*(1-y(31)))*y(28); %phospho-Byr1 in scd1-Delta
