% diffunModel_CG25.m
% made on Jan 29, 2022, based on diffunModel_CF26.m 
% remove s(6): ppSpk1->Ste4/6
% rename s(26) as s(6)
% see 220122RunFitting.xlsx
% 25 parameters

function dydt = diffunModel_CG25(~,y,r)
dydt = zeros(32,1);
...
dydt(2) = s(4)*y(1) - s(5)*y(2); %active Ste4/Ste6 in WT
...
dydt(5) = s(13)*y(2)*(1+s(14)*y(3)+s(15)*y(4)/s(19))*(1-y(5))-s(16)*(1+s(6)*(1-y(31)))*y(5); %phospho-Byr1 in WT
...
dydt(9) = s(4)*y(8) - s(5)*y(9); %active Ste4/Ste6 in ras1.G17V
...
dydt(11) = s(13)*y(9)*(1+s(14)*s(22)+s(15)*y(10)/s(19))*(1-y(11))-s(16)*(1+s(6)*(1-y(31)))*y(11); %phospho-Byr1 in ras1.G17V 
...
dydt(15) = s(4)*y(14) - s(5)*y(15); %active Ste4/Ste6 in byr1.DD
...
dydt(21) = s(4)*y(20) - s(5)*y(21); %active Ste4/Ste6 in ras1.G17V+byr1.DD
...
dydt(26) = s(4)*y(25) - s(5)*y(26); %active Ste4/Ste6 in scd1-Delta
dydt(27) = s(7)*y(26)*(1-y(27)) - s(8)*y(27); %active Ras in scd1-Delta
% 0; % Cdc42 in scd1-Delta
dydt(28) = s(13)*y(26)*(1+s(14)*y(27))*(1-y(28))-s(16)*(1+s(6)*(1-y(31)))*y(28); %phospho-Byr1 in scd1-Delta
