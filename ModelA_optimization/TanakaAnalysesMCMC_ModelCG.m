...
r = AveR(1:RN);
Yave = RtoODE_ModelCG(r,tspan,y0,expvalue125); % modified 220128
...
y0 = zeros(32,1); % initial amounts of each component are zero
r = MaxR(1:RN);
Ymax = RtoODE_ModelCG(r,tspan,y0,expvalue125);
for i=1:12 % modified 220128
    subplot(6,2,i) % modified 220128
    temp = plotrange(i,2):plotrange(i,3);
...
load('Output.mat')
r = output;
Yini = RtoODE_ModelCG(r,tspan,y0,expvalue125); % modified 220128
for i=1:12 % modified 220128
    subplot(6,2,i) % modified 220128
    temp = plotrange(i,2):plotrange(i,3);
