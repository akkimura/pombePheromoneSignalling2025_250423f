...
% create a 25-element optimization variable r that has a lower bound of 0.1 and an upper bound of 10.
r = optimvar('r',25,"LowerBound",0.1,"UpperBound",10);
...
myfcn = fcn2optimexpr(@RtoODE_ModelCG,r,tspan,y0,expvalue125);
...
figure
yvals2 = RtoODE_ModelCG(rsol.r,tspan,y0,expvalue125);
