...
% create a 26-element optimization variable r that has a lower bound of 0.1 and an upper bound of 10.
r = optimvar('r',26,"LowerBound",0.1,"UpperBound",10);
...
myfcn = fcn2optimexpr(@RtoODE_ModelCF,r,tspan,y0,expvalue125);
...
figure
yvals2 = RtoODE_ModelCF(rsol.r,tspan,y0,expvalue125);
